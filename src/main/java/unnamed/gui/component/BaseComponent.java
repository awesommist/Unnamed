...
import unnamed.gui.listener.IKeyTypedListener;
import unnamed.gui.listener.IMouseDownListener;
import unnamed.gui.listener.IMouseDragListener;
import unnamed.gui.listener.IMouseUpListener;
import unnamed.utils.TextureUtils;
...
public abstract class BaseComponent extends Gui {
    ...
    public static final ResourceLocation TEXTURE_SHEET = new ResourceLocation("unnamed", "textures/gui/components.png");
