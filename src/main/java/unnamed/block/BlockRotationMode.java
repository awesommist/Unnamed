...
import unnamed.geometry.BlockTextureTransform;
import unnamed.geometry.HalfAxis;
import unnamed.geometry.Orientation;
import unnamed.renderer.rotations.IRendererSetup;
import unnamed.renderer.rotations.RendererSetupProxy;
...
public enum BlockRotationMode {
    ...
    BlockRotationMode(ForgeDirection[] rotations, Orientation... validOrientations) {
