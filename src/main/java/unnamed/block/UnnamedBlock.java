...
import unnamed.geometry.BlockSpaceTransform;
...
import unnamed.utils.BlockNotifyFlags;
import unnamed.utils.BlockUtils;
...
public abstract class UnnamedBlock extends Block implements IRegisterableBlock {
    ...
    protected UnnamedBlock(Material material) {
        ...
        // I don't think vanilla actually uses this...
    ...
    public static UnnamedBlock getOpenBlock(IBlockAccess world, int x, int y, int z) {
        if (world == null) return null;
        Block block = world.getBlock(x, y, z);
        if (block instanceof UnnamedBlock) return (UnnamedBlock) block;
        return null;
    }
    ...
    public TileEntity createTileEntity(World world, int metadata) {
        ...
        if (te != null) {
            te.blockType = this;
            if (te instanceof UnnamedTileEntity) {
                ((UnnamedTileEntity) te).setup();
            }
        }
    ...
    public static boolean isNeighborBlockSolid(IBlockAccess world, int x, int y, int z, ForgeDirection side) {
        x += side.offsetX;
        y += side.offsetY;
        z += side.offsetZ;
    ...
    public static boolean areNeighborBlocksSolid(World world, int x, int y, int z, ForgeDirection... sides) {
    ...
    public void openGui(EntityPlayer player, World world, int x, int y, int z) {
        player.openGui(getModInstance(), UNNAMED_TE_GUI, world, x, y, z);
    }
