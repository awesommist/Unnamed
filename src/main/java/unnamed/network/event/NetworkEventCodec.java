...
import unnamed.utils.io.PacketChunker;
...
public class NetworkEventCodec extends MessageToMessageCodec<FMLProxyPacket, NetworkEvent> {
    ...
    protected void decode(ChannelHandlerContext ctx, FMLProxyPacket msg, List<Object> out) throws Exception {
        ...
        if (handler != null) event.sender = Unnamed.proxy.getPlayerFromHandler(handler);
    ...
    private static FMLProxyPacket createPacket(int id, byte[] payload) {
        ...
        return new FMLProxyPacket(buf.copy(), NetworkEventDispatcher.CHANNEL_NAME);
    }
