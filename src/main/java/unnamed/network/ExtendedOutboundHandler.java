...
public class ExtendedOutboundHandler extends ChannelOutboundHandlerAdapter {
    ...
    public static final AttributeKey<IPacketTargetSelector> MESSAGE_TARGET = new AttributeKey<IPacketTargetSelector>("unnamed:outboundTarget");
    ...
    public void write(ChannelHandlerContext ctx, Object msg, ChannelPromise promise) throws Exception {
        ...
        final IPacketTargetSelector target = channel.attr(MESSAGE_TARGET).get();
        if (target == null) {
            ctx.write(msg);
            return;
        }
    ...
    public static void selectTargets(EmbeddedChannel channel, IPacketTargetSelector selector, Object arg) {
        channel.attr(MESSAGE_TARGET).set(selector);
