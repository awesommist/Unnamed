...
public class RpcCallDispatcher extends Dispatcher {
    ...
    public static final String CHANNEL_NAME = "Unnamed|RPC";
    ...
    private RpcCallDispatcher() {
        channels = NetworkRegistry.INSTANCE.newChannel(CHANNEL_NAME, new RpcCallCodec(targetRegistry, methodRegistry), new RpcCallInboundHandler());
        ExtendedOutboundHandler.install(channels);
