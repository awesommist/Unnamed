...
public class RpcSetup {
    ...
    RpcSetup() {
        methodsStoreBuilder = IdSyncManager.INSTANCE.createDataStore("rpc_methods", String.class, Integer.class);

        methodsStoreBuilder.setDefaultKeyReaderWriter();
        methodsStoreBuilder.setValueReaderWriter(TypeRW.VLI_SERIALIZABLE);

        targetsStoreBuilder = IdSyncManager.INSTANCE.createDataStore("rpc_targets", String.class, Integer.class);
